class AppConstants {
  ...
  /// 최신 기수 값
  static const int maxGeneration = 12;
  ...
  static const List<({String asset, String url})> banners = [
    (
      ...
      url: 'https://crystal-bowler-ff6.notion.site/71819cd3705b44eeb5b521ecfe1b7081?pvs=4',
    ),
    (
      asset: 'assets/banners/notice.svg',
      url: 'https://crystal-bowler-ff6.notion.site/ba37dd63ec12486a98c34a14a7eb0cc2?pvs=4',
    ),
    (
      asset: 'assets/banners/rules.svg',
      url: 'https://crystal-bowler-ff6.notion.site/Roccia-901-caedf2c1c911416c8162f7aaa25b59ae?pvs=4',
    ),
    (
      asset: 'assets/banners/report.png',
      url: 'https://docs.google.com/forms/d/1Fg3Nk0H3nAoAYAq5elkzUyn69latA9Nv6tJGgD-aENU/edit',
    ),
  ];
